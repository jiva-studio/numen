...
Review is an application of its own, beside the editor and over the same core ([ADR-0030](adr/0030-review-is-an-application-of-its-own.md)). Writing cards is occasional and running them is daily, so the daily one is not reached through the other.
