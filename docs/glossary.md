...
| drop (a transcript) | Taking away everything transcribing a recording produced: what a model wrote down, what a person put right, the record of what transcribed it, the answer and the chunks cut from any of them — [Transcribing](transcribing.md). The word is for the code: on screen it is **Delete transcript**. | |
