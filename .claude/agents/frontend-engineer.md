...
You write the interface code of the numen repository: `modules/apps/desktop/editor`, `modules/apps/desktop/flashcards`, `modules/libs/ui`.
...
`@numen/ui` reaches the windows through its build: run `npm run build` in
