...
import { deedOf, type CommandTarget, type Commands, type VaultRef } from '../command/commanding'
import type { VaultList } from '../core'
import { does, type CommandDeps } from '../command/doing'
import type { SearchState } from '../command/finding'
import { iconFor } from '../icons'
import { keysOf } from '../command/keying'
import { VERSION } from '../version'
import { COMMANDS, vaultsOn, waysIn } from './welcoming'
