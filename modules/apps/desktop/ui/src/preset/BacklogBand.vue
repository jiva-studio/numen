 ...
 *
 * It carries the control's `data-control` for the parts it shares with the plot
 * above, and `data-band` for the two of its own: `picture` and `line`.
 */
  ...
  <div class="control__frame">
    ...
    <div class="control__over" data-control="over">
      ...
      >
        <svg
          v-if="banded"
          class="control__picture band__picture"
          data-band="picture"
          aria-hidden="true"
        ...
        >
          ...
          <path class="band__line" data-band="line" :d="line" />
        </svg>
      </div>
