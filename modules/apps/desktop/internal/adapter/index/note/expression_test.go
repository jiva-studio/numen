...
func TestAMarkedNameIsReadBackAsTheNameAndTheRunsInIt(t *testing.T) {
	for _, c := range []struct {
		...
		{"Entropy", "Entropy", nil},
		{"\x02Entropy\x03", "Entropy", []domain.Span{{From: 0, To: 7}}},
		{"The \x02Carnot\x03 cycle", "The Carnot cycle", []domain.Span{{From: 4, To: 10}}},
		{
			"\x02Heat\x03 and \x02work\x03",
			"Heat and work",
			[]domain.Span{{From: 0, To: 4}, {From: 9, To: 13}},
		},
		...
		{"👋 \x02Entropy\x03", "👋 Entropy", []domain.Span{{From: 3, To: 10}}},
		{"\x02👋\x03 Entropy", "👋 Entropy", []domain.Span{{From: 0, To: 2}}},
	} {
