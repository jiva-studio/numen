...
// ErrNoPicker is a machine that cannot put a folder picker up. A folder is
// named to this application some other way, and a vault is added by its path.
var ErrNoPicker = errors.New("this machine cannot put a folder picker up")
...
type Folders interface {
	...
	//
	// It answers ErrChoosing where a picker is already up, and ErrNoPicker
	// where this machine cannot put one up at all.
