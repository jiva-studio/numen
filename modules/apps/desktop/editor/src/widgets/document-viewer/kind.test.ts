...
import { ref } from 'vue'
import { documentKind, useDocumentTab, type DocumentTabState, type PageHandle } from './kind'
...
/** A mock window writing down what it was asked to open and returning a given tab state. */
