...
import { useAppearanceChoice } from './model/choice'

export type { Words } from './appearanceWords'
export { APPEARANCE, APPEARANCE_COMMANDS, INTERFACE_SCALE, MODE, TEXT_SCALE } from './lib/appearanceValues'
