...
import SettingsTab from '../settings-tab/SettingsTab.vue'
import type { Installation } from '../settings-tab/kind'
import PresetTab from '../flashcards-preset-tab/PresetTab.vue'
import {
  DEFAULTS,
  type Curve,
  type Point,
  ...
  type SettingsBounds,
} from '../flashcards-preset-tab/core'
import type { PresetTabState } from '../flashcards-preset-tab/kind'
import DeckTab from '../flashcards-deck-tab/DeckTab.vue'
import type { DeckTabState } from '../flashcards-deck-tab/deckTabs'
import StencilTab from '../flashcards-stencil-tab/StencilTab.vue'
