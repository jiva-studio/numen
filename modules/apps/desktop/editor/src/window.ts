...
import { cards } from './features/cards/vault/cards'
import type { Attention, ArtifactStates, Source, VaultList } from './shared/core'
import { showing } from './showing'
import { view } from './features/plex/view'
import { openDocument } from './features/document/open'
import { cornerOf } from './shared/notices/corner'
import type { IndexCoverage } from './shared/notices/coverage'
import { openNotes } from './features/note/notes'
import { noteChanges } from './features/note/changes'
import { CREATABLE, noteMaker } from './features/note/maker'
import { runSupport } from './shared/command/runs'
import { invocationOf, type VaultRef, type CommandTarget } from './shared/command/target'
...
import { reviewSetting } from './features/settings/review'
import { OFF, ON, SYNCING, syncSetting } from './features/settings/sync'
import { HANGING, PARTS, hanging } from './features/settings/hanging'
import { reaching, type CommandDeps, type Store } from './shared/command/deps'
...
import { agentKind, talking } from './features/agent/kind'
import { decking } from './features/cards/deck-tab/deckTabs'
import { stencilling } from './features/cards/stencil-tab/stencilTabs'
import { presets } from './features/preset/core'
import { presetting } from './features/preset/kind'
import { settingsStore } from './features/settings/store'
import { settling } from './features/settings/controls/kind'
import { editingSettingsFile } from './features/settings/file/kind'
import { documentKind, documenting } from './features/document/kind'
import { RECORDINGS, recordingKind, URLS, type MediaTabDeps } from './features/media/kind'
import { transcript } from './features/media/transcript'
import { playable } from './features/media/player'
import { filesKind } from './features/files/kind'
import { listing as folders } from './features/files/listing'
import { noting } from './features/note/kind'
import { plexKind } from './features/plex/kind'
import { core as agent } from './features/agent/core'
import { WORDS as talk } from './features/agent/words'
import { WORDS as cardWords } from './features/cards/words'
