...
If you would rather they were two separate things, `naming.sync_title_and_filename: false` in
[the settings](/settings/) tells them apart: a new title then stays inside the note, and a
renamed file stays renamed.
