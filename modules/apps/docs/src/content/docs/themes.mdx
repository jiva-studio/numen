...
<Shot
  name="window"
  alt="The numen window drawn in the palette that ships with it."
  caption="numen's own palette. This page is showing you the half you are reading in; the window follows the same rule."
/>
