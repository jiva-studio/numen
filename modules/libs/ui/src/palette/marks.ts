 ...
 *
 * The letter's stem is 0.086em at the type a cap is set in and its capitals are
 * 0.713em tall, so a box of 0.85em carries a 20-unit mark at that height and
 * 2.4 units of stroke land on that stem.
 */
const STROKE = 2.4
