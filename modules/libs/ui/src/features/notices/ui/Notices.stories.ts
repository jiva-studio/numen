...
export const NoTotalYet: Story = {
  args: { notices: [{ id: 'embedding', says: 'Preparing search by meaning', isWorking: true }] },
}
...
export const TooMuchToSay: Story = {
  args: {
    notices: [
      { id: 'one', says: RUSSIAN, about: LONG, done: 1, total: 2, isWorking: true },
      { id: 'two', says: UNBREAKABLE, about: UNBREAKABLE, isWorking: true },
      { id: 'three', says: RUSSIAN, about: LONG, tone: 'alarm', stay: 'kept', isAsked: true },
      { id: 'brief', says: 'Reading', isWorking: true },
    ],
  },
  play: async () => {
    await waitFor(() => expect(cards()).toHaveLength(4))
