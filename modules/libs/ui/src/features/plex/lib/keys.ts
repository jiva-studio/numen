...
export const isPress = (event: KeyboardEvent): boolean => event.key === 'Enter' || event.key === ' '
 ...
 */
export const isShowKey = (event: KeyboardEvent): boolean => event.shiftKey && isPress(event)
