...
/** The getFurthest the window on the parts may be scrolled down, counted in parts. */
export const getFurthest = (hung: NodeParts): number => Math.max(0, hung.parts.length - hung.shown)
