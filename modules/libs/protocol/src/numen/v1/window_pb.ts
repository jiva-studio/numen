...
export const file_numen_v1_window: GenFile = /*@__PURE__*/
  fileDesc("");
...
export type Task = Message<"numen.v1.Task"> & {
   ...
   * before that.
   *
   * @generated from field: bool is_asked = 7;
   */
  isAsked: boolean;
...
export enum FlushResult {
   ...
   *
   * @generated from enum value: FLUSH_RESULT_NOTHING = 1;
   */
  NOTHING = 1,
   ...
   *
   * @generated from enum value: FLUSH_RESULT_WRITTEN = 2;
   */
  WRITTEN = 2,
   ...
   *
   * @generated from enum value: FLUSH_RESULT_ASKING = 3;
   */
  ASKING = 3,
}
