...
func (x *Seated) GetAnswered() bool {
	if x != nil {
		return x.Answered
	}
	return false
...
const file_numen_v1_vault_proto_rawDesc = "" +
	...
	"\athrough\x18\x04 \x01(\tR\athrough\x12\x1a\n" +
	"\banswered\x18\x05 \x01(\bR\banswered\"\x0e\n" +
	...
	"\x06Remove\x12\x17.numen.v1.RemoveRequest\x1a\x18.numen.v1.RemoveResponse\x12C\n" +
...
func file_numen_v1_vault_proto_init() {
	...
	file_numen_v1_vault_proto_msgTypes[39].OneofWrappers = []any{}
