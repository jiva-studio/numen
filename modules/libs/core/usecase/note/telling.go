...
// Telling is what a write says about itself while it is being made, for whoever
// is looking at the note. Nothing is said where nobody is drawing.
type Telling func(ctx context.Context, said domain.Editing)
...
func (tell Telling) begins(ctx context.Context, said domain.Editing) func() {
	if tell == nil {
		return func() {}
	}
