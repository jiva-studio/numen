...
type API struct {
	...
	// What this window does, one scenario to a field: what a vault owes, what
	// to ask next, where the answers leave a card, the run they are appended
	// to, and the deck a card is put right in.
	Owed      review.Owed
