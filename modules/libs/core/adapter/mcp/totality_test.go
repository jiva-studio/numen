...
// TestEveryErrorCodeIsWorded. An error code the sentences do not name is
...
func TestEveryErrorCodeIsWorded(t *testing.T) {
	testsupport.Handled(t, func(reason v1.ErrorCode) bool { return said(reason) != reason.String() })
}
