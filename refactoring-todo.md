...
- [ ] Разложить файлы, оставшиеся в корне срезов: `preset-editor`, `deck-editor`, `note-editor`, `file-manager`. После выноса фабрик их стало меньше, но `model/` и `lib/` там ещё не наполнены.
